...
export const RichTextComponents = {
    ...
    block : {
        ...
        blockquote: ({children}: any) => <blockquote className='border-l-[#CBB7F2] border-l-4 pl-5 my-5'>{children}</blockquote>,
    },
    marks: {
        link: ({children, value}: any) => {
            ...
            return (
                <Link href = {value.href} rel = {rel} className = "underline decoration-[#CBB7F2] hover:decoration-black">
                    {children}
                </Link>
            )
        }
